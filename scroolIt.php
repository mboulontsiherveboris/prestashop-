...
class ScroolIt extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('Ajouter un message défilant');
    ...
    protected function getConfigForm()
    {
        return array(
            'form' => array(
                'legend' => array(
                    'title' => $this->l('RÉGLAGE DU TEXTE DE DÉFILEMENT'),
                    'icon' => 'icon-cogs',
                ),
                'input' => array(
                    array(
                        'type' => 'textarea',
                        'label' => $this->l('le Texte'),
                        'name' => 'SCROOLIT_TEXT',
                        'desc' => $this->l('le texte qui vas defiler')
                    ),
                    array(
                        'col' => 3,
                        'type' => 'text',
                        'prefix' => '<i class="fa fa-fast-forward" aria-hidden="true"></i>',
                        'desc' => $this->l('entrer la vitesse '),
                        'name' => 'SCROOLIT_TEXT_SPEED',
                        'label' => $this->l('La vitesse du texte défilant'),
                    ),
                    array(
                        'col' => 3,
                        'type' => 'select',
                        'options' => array(
                            'query' => array(
                                array(
                                    ...
                                    'name' => 'De gauche à droite'    // The value of the text content of the  <option> tag.
                                ),
                                array(
                                    'id_option' => 'Right',
                                ...
                                array(
                                    ...
                                    'name' => ' De haut en bas'    // The value of the text content of the  <option> tag.
                                ),
                                array(
                                    'id_option' => 'bottom',
                                    'name' => 'De bas en haut'
                        ...
                        'label' => $this->l('La direction du texte défilant'),
                    ),
                ),
                'submit' => array(
